...
- If the node if not found, return false
...
- Create a variable called node and initialize it to start at the head property
- Loop through the list
- Set next to be the next property on whatever the node is
